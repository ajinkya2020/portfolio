    ...
    <div className='mt-20'>
      ...
      <form className='contact-form mt-10 mx-auto'>
        <div className='flex-col'>
          ...
          <div className="relative mt-5">
            <textarea type="text" rows={10} className="block rounded-t-lg rounded-b-lg px-2.5 pb-2.5 pt-5 w-full text-sm text-gray-900 bg-gray-50 dark:bg-gray-600 appearance-none dark:text-white dark:border-gray-600 focus:outline-none focus:ring-0 peer" placeholder=" "></textarea>
